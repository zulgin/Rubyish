# prints the string "I will now count my chickens" you fucking chicken knoikc knoic knoic. you..... you.... chicken... chicken... chicken knoic knoic knoic I need a reason to believe 151 aunque en volum bajo pero en buenos speakers bistec a los oidos.
puts "I will now count my chickens"

# prints the string "Hens", prints the result of the following operation:divides 30 into 6 and adds the quotient to 25 which is 30
puts "Hens", 25 + 30 / 6

# prints the string "Roosters", prints the result of the following operation:4% of 3 is multiplied by 25 the product of which is subtracted from 100 to equal 97
# or... prints the result of the following operation: 25 is multiplied by 3, 4% of the product is then subtracted from 100 to equal 97
...
# prints the string "What is 5 - 7?" and prints the result of 5 - 7 which is -2
